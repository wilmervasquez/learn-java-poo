...
public class AlquilerUI extends JFrame {
  ...
  public AlquilerUI() {
    ...
    JLabel l2 = new JLabel("Película");
    l2.setBounds(340, 20, 80, 25);
    JLabel l3 = new JLabel("Fecha Alq (yyyy-MM-dd)");
    l3.setBounds(20, 60, 160, 25);
    JLabel l4 = new JLabel("Fecha Dev (yyyy-MM-dd)");
    l4.setBounds(20, 100, 160, 25);
    JLabel l5 = new JLabel("Precio");
    l5.setBounds(340, 60, 80, 25);
    JLabel l6 = new JLabel("Estado");
    l6.setBounds(340, 100, 80, 25);

    cbClientes = new JComboBox<>();
    cbClientes.setBounds(100, 20, 220, 25);
    cbPeliculas = new JComboBox<>();
    cbPeliculas.setBounds(420, 20, 300, 25);
    txtFechaAlq = new JTextField();
    txtFechaAlq.setBounds(180, 60, 140, 25);
    txtFechaDev = new JTextField();
    txtFechaDev.setBounds(180, 100, 140, 25);
    txtPrecio = new JTextField();
    txtPrecio.setBounds(420, 60, 140, 25);
    txtEstado = new JTextField();
    txtEstado.setBounds(420, 100, 140, 25);

    JButton btnAgregar = new JButton("Agregar");
    btnAgregar.setBounds(600, 60, 120, 25);
    JButton btnEditar = new JButton("Editar");
    btnEditar.setBounds(600, 95, 120, 25);
    JButton btnEliminar = new JButton("Eliminar");
    btnEliminar.setBounds(740, 60, 120, 25);
    JButton btnRefrescar = new JButton("Refrescar");
    btnRefrescar.setBounds(740, 95, 120, 25);

    modelo = new DefaultTableModel(
        new String[] { "ID", "Cliente", "Pelicula", "FechaAlq", "FechaDev", "Precio", "Estado" }, 0) {
    ...
    btnAgregar.addActionListener(e -> {
      ...
      if (cli == null || pel == null) {
        JOptionPane.showMessageDialog(this, "Selecciona cliente y película");
        return;
      }
      ...
      if (creado != null) {
        ...
        JOptionPane.showMessageDialog(this, "Error al crear alquiler");
    });
  ...
  private void selectCombo(Cliente c, Pelicula p) {
    if (c != null) {
      for (int i = 0; i < cbClientes.getItemCount(); i++)
        if (cbClientes.getItemAt(i).getId() == c.getId()) {
    ...
    if (p != null) {
      for (int i = 0; i < cbPeliculas.getItemCount(); i++)
        if (cbPeliculas.getItemAt(i).getId() == p.getId()) {
          cbPeliculas.setSelectedIndex(i);
          break;
        }
    }
  }
  ...
  private void cargarCombos() {
    ...
    // To show useful text in combobox, override toString in Cliente and Pelicula
    // models:
  ...
  void cargarTabla() {
    ...
    if (lista != null) {
      for (Alquiler a : lista) {
        ...
        String clienteText = (c != null) ? (c.getId() + " - " + c.getNombres() + " " + c.getApellidos())
