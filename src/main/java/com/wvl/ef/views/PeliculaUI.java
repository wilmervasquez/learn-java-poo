...
public class PeliculaUI extends JFrame {
  ...
  public PeliculaUI() {
    ...
    JLabel l3 = new JLabel("Género");
    l3.setBounds(20, 80, 100, 25);
    JLabel l4 = new JLabel("Duración (min)");
    l4.setBounds(20, 110, 120, 25);

    txtCodigo = new JTextField();
    txtCodigo.setBounds(140, 20, 240, 25);
    txtTitulo = new JTextField();
    txtTitulo.setBounds(140, 50, 240, 25);
    txtGenero = new JTextField();
    txtGenero.setBounds(140, 80, 240, 25);
    txtDur = new JTextField();
    txtDur.setBounds(140, 110, 240, 25);

    JButton btnAgregar = new JButton("Agregar");
    btnAgregar.setBounds(400, 20, 120, 25);
    JButton btnEditar = new JButton("Editar");
    btnEditar.setBounds(400, 55, 120, 25);
    JButton btnEliminar = new JButton("Eliminar");
    btnEliminar.setBounds(400, 90, 120, 25);
    JButton btnRefrescar = new JButton("Refrescar");
    btnRefrescar.setBounds(400, 125, 120, 25);
